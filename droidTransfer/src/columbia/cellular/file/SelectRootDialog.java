...
public class SelectRootDialog {
	...
	public static Dialog createDialog(int id, Context context, String title, final CallbackBundle callback, Map<String, Integer> images){
	...
	static class FileSelectView extends ListView implements OnItemClickListener{
		...
		public FileSelectView(Context context, int dialogid, CallbackBundle callback,  Map<String, Integer> images) {
			super(context);
