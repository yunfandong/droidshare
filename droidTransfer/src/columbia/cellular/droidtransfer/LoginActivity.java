...
public class LoginActivity extends FtDroidActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final String ip =IpUtils.getIPAddress(false);; // true: IPv4 false:IPv6
		initGCM();
		
		if(isRegistered()){
			//Toast.makeText(this, "Device is already registered"+getRegisteredDevice().toString(), Toast.LENGTH_LONG).show();
			//testPairWith();
			//testPairResponse();
			//testPairDelete();
			//testPairList();
		...
		DLog.i("attempting to log in ");
		 ...
		 button.setOnClickListener(new OnClickListener() {
	            public void onClick(View v) {
	            	...
	            	Toast.makeText(getApplicationContext(), "Please Input NickName ^_^", Toast.LENGTH_SHORT).show();
	            	}
	            	else if(Email.getText().toString().isEmpty()){
		            Toast.makeText(getApplicationContext(), "Please Input Email ^_^", Toast.LENGTH_SHORT).show();
		            }
	        		...
	        		Device device = new Device(nickName.getText().toString(), Email.getText().toString(), imei,registrationId);
	        		
	        		DLog.i("Registering Device: "+nickName.getText().toString()+" " + registrationId);
	...
	public void handleError(ApiError[] errors, ApiEntity entity) {
		...
		//Toast.makeText(this, "An exception occured", Toast.LENGTH_LONG).show();
	}
